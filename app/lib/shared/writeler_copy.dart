final class WritelerCopy {
  ...
  static const _de = {
    ...
    'emptyBody': 'Lege ein lokales Schreibprojekt an und strukturiere es in Kapitel, Szenen und Notizen.',
    ...
    'noScenesBody': 'Lege eine Szene an, um Manuskript, Ziel, Konflikt und Ausgang zu planen.',
    ...
    'catalogEmptyBody': 'Lege Profile an und nutze sie als Kontext fuer Szenen, Analyse und KI-Vorschlaege.',
    'noSummary': 'Keine Zusammenfassung',
    'sceneContext': 'Szenenkontext',
    'sceneContextEmpty': 'Lege Figuren, Orte oder Objekte an, um sie mit dieser Szene zu verknuepfen.',
    ...
    'aiNeedsScene': 'Lege zuerst eine Szene an, bevor KI-Vorschlaege erzeugt werden.',
    'aiContext': 'Kontext',
    'aiPrompt': 'Auftrag an die KI',
    'defaultAiPrompt': 'Pruefe diese Szene und schlage strukturierende Fragen vor.',
    ...
    'baseUrl': 'Base-URL',
    'apiKeyRef': 'API-Key',
    'apiKeyWebWarning': 'Wird getrennt von der Provider-Konfiguration sicher lokal gespeichert.',
    'apiKeyStoredHint': 'API-Key ist sicher gespeichert. Leer lassen, um ihn beizubehalten.',
  ...
  static const _en = {
    ...
    'emptyBody': 'Create a local writing project and organize it into chapters, scenes, and notes.',
    ...
    'noScenesBody': 'Create a scene to plan manuscript, goal, conflict, and outcome.',
    ...
    'catalogEmptyBody': 'Create profiles and use them as context for scenes, analysis, and AI suggestions.',
    'noSummary': 'No summary',
    'sceneContext': 'Scene context',
    'sceneContextEmpty': 'Create characters, locations, or objects to link them with this scene.',
    ...
    'baseUrl': 'Base URL',
    'apiKeyRef': 'API key',
    'apiKeyWebWarning': 'Stored locally in secure storage, separate from provider configuration.',
